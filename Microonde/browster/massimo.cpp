...
int main (int argc, char ** argv)
{
  ...
  std::cout << "Massimo della funzione " << sezioneAurea_max (fcos, x_min, x_max, risoluzione) << std::endl;
  std::cout << "Massimo della funzione usando la funzione ricorsiva " << sezioneAurea_max_ricorsiva (fcos, x_min, x_max, risoluzione) << std::endl;
